...
import { getBusinessPerformanceEntityDetail } from "@/services/business-performance-service";
...
export async function GET(request: NextRequest, { params }: RouteContext) {
  ...
  try {
    const data = await getBusinessPerformanceEntityDetail({
      entityId: params.id,
    ...
    const message = error instanceof Error ? error.message : "Unable to load business performance entity detail.";
